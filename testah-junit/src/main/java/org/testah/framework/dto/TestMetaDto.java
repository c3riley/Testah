...
public class TestMetaDto {
    ...
    public TestMetaDto(final TestCase metadata) {
        fillFromTestCase(metadata);
    }

    public TestMetaDto(final TestPlan metadata) {
        fillFromTestPlan(metadata);
    }
    ...
    public TestMetaDto fillFromTestCase(final TestCase metadata) {
        return fillFromTestCase(metadata, null);
    }
    ...
    public TestMetaDto fillFromTestPlan(final TestPlan metadata) {
        return fillFromTestPlan(metadata, null);
    }
