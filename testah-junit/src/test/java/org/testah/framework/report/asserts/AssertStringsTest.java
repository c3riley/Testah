...
public class AssertStringsTest {
    ...
    public AssertStrings assertStrings = new AssertStrings(new VerboseAsserts().onlyVerfiy());
    ...
    public void testDiffBetweenStrings()
    {
        ...
        final String acutal = "\tPOOLED FUNDS RETURNS BY ASSET CLASS,,,,,,,,,,,,,,,,,";

        String diffString = assertStrings.getEasyToDebugStringForStringDifferences(expected, acutal);
    ...
    {
        StringBuilder sb = new StringBuilder(lineValue);
